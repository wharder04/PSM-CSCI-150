        ...
        <DashboardLayout>
            <div className="min-h-screen p-8 bg-gray-100 text-black">
                <div>
                    ...
                    <button className="flex items-center gap-2 bg-gray-300 text-black font-sans rounded w-32 h-10"><MdAdd size={20} color="black"/>Create New Task</button>
                </div>
                <div className="flex flex-row">
                    <div className="flex flex-col items-center border-2 border-black w-32 h-96 rounded">
                        <div className="flex items-center justify-between w-full px-2 mb-2 text-black font-sans">
                            <p>Unassigned</p>
                            <button className="w-7 h-7 flex items-center justify-center"><MdAdd size={30} color="black"/></button>
                        </div>
