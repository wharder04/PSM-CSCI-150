...
export default function TaskBoard() {
    ...
    const filteredTasks = useMemo(() => {
        const { startOfToday, endOfToday, startOfWeek, endOfWeek } = getDateRangeAnchors(
            new Date()
        );
    ...
    const onAddComment = async (taskId, text) => {
        try {
            ...
            console.error(e);
            toast.error(e?.response?.data?.error || e?.message || "Failed to add comment");
            return false;
        } finally {
