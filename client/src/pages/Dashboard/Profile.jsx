    ...
    <div className="p-4">
      ...
      <div className="bg-gray-200 rounded-2xl p-8 mt-6">
        ...
        <div className="flex items-start gap-8 mt-6">
          <div className="w-32 h-32 aspect-square bg-gray-400 rounded-full flex items-center justify-center shrink-0"></div>
          <div>
        ...
        />
        <p className="text-gray-600 text-sm mb-4">Your name or nickname</p>
