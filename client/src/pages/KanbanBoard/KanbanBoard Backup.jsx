  ...
  return (
    <div className="min-h-screen w-full flex flex-col p-10 bg-gray-100 text-black">
      <div className="w-1/3 h-full p-8 flex flex-col">
        <div className="mb-6">
          <p className="text-2x1 font-semibold text-black bg-gray-200">
            Project Description
          </p>
        ...
        <div className="flex flex-row gap-4 mb-6">
          ...
          <div className="bg-gray-200 p-4 w-40 h-32 rounded flex flex-col">
            <p className="text-black font-semibold text-2x1">
              Incomplete Tasks
            </p>
            <p className="text-black font-semibold text-2x1">
              {incompleteTasks}
        ...
        <div className="mb-6">
          <button className="bg-gray-800 text-white font-sans rounded w-24 h-10 mb-4 cursor-pointer">
            + New Task
          </button>
        </div>
        <div>
        ...
        <div className="gap-4 mb-4">
              ...
              <table className="w-full table-fixed text-left">
                <thead className="bg-gray-100">
                  <tr className="h-12">
                    ...
                    <th className="px-4 py-2 w-1/5 text-sm text-black">
                      Assigned To
                    </th>
                    <th className="px-4 py-2 w-1/5 text-sm text-black">
                      Assignee
                ...
                <tbody className="bg-gray-100 text-sm text-black">
                  {tasks.map((task) => (
                    <tr className="border-t border-gray-200 h-12" key={task.id}>
                      ...
                      <td className="text-black text-sm px-4">
                        {task.assignedTo}
                      </td>
                      <td className="text-black text-sm px-4">
                        {task.assigneeId}
          ...
          {activeSection === "teamActive" && (
            <div className="flex flex-row gap-4 mb-4 justify-start">
              {team.map((teamMember) => (
                <div
                  className="w-40 h-32 bg-white rounded mb-4"
                  key={teamMember.id}
                >
